...
async function createInitialMerchandise() {
  try {
    ...
    const merchandiseToCreate = [
      ...
      { img: `https://ik.imagekit.io/theartling/p/products/Product/97702d17a693459189d57a139990de2c.png`, name: 'Cash Owns Everything Around Me', artist: 'Resatio Adi Putra', price: '250', rating: '10', cat: 'Popart' },
      { img: `https://ik.imagekit.io/theartling/p/products/Product/9101370e619244749ddeb8fe237247ce.jpg?tr=cm-pad_resize,w-1072,h-1072,bg-FFFFFF`, name: 'Massive Stars Collapse III', artist: 'Resatio Adi Putra', price: '58', rating: '8', cat: 'Popart' },
      ...
      { img: `https://i.imgur.com/cEwoIwJ.jpg`, name: 'Village in Mexico', artist: 'Jacques Zucker', price: '5250', rating: '9', cat: 'PostImpressionalism' },
